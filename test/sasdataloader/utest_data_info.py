...
class Data1DTests(unittest.TestCase):
    ...
    def test_interpolation_operation(self):
        ...
        # check handling of resolutions without interpolation
        # test overlap of x2 at low x1
        ...
        # check handling of resolutions with interpolation
        # test overlap of x2 at low x1
    ...
    def test_perform_operation(self):
        ...
        self.assertIsNone(result.dx)
        self.assertIsNone(result.dxl)
        self.assertIsNone(result.dxw)
        self.assertIsNone(result.lam)
        self.assertIsNone(result.dlam)
