...
class sesans_reader(unittest.TestCase):
    ...
    def test_full_load(self):
        ...
        self.assertAlmostEqual(f.x[0], 391.56)
        self.assertAlmostEqual(f.x[-1], 46099)
        self.assertAlmostEqual(f.y[-1], -0.19956)
        ...
        self.assertAlmostEqual(f.sample.thickness, 0.2)
        self.assertAlmostEqual(f.sample.zacceptance, (0.0168, "radians"))
    ...
    def test_sesans_tof(self):
        ...
        self.assertAlmostEqual(f.x[-1], 19303.4)
        self.assertAlmostEqual(f.source.wavelength[-1], 13.893668)
        self.assertAlmostEqual(f.source.wavelength[0], 1.612452)
