...
||||||| parent of 7c26dcaf (Adds Pyupgrade (UP) ruleset and rules SIM118 & SIM300 to ruff linter (#144))
...
def load_data(filename: str) -> dict[str, SasData]:
    with h5py.File(filename, "r") as f:
        loaded_data: dict[str, SasData] = {}
>>>>>>> 7c26dcaf (Adds Pyupgrade (UP) ruleset and rules SIM118 & SIM300 to ruff linter (#144))
