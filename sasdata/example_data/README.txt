Example data sets are included as a convenience to our users. The data sets are organized based on their data structure; 1D data (ie, I(Q)), 2D data (ie, I(Qx,Qy)), image data (eg, TIFF files), and SESANS data, to name a few.
...
2D data sets are data sets that give the reduced intensity for each QX, Qx point. Depending on the file extension, uncertainty and metadata may also be available.
