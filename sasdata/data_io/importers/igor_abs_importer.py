...
class Reader(Importer):
    """
    Class to import IGOR reduced .ABS SAS and .COR USAS data files
    """
    # File type
    type_name = "IGOR 1D Absolute intensity data importer"
    # Wildcards
