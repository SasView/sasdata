...
class TestLists(TestCase):
    ...
    def test_does_list_public(self):
        request = self.client_authenticated.get("/v1/data/file/")
        self.assertEqual(
            request.data,
...
class TestingDatabase(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.client_authenticated = APIClient()
        cls.client_authenticated.force_authenticate(user=cls.user)
        cls.client_unauthenticated = APIClient()
    ...
    def test_is_data_being_created(self):
        ...
        request = self.client_authenticated.post("/v1/data/file/", data=data)
    ...
    def test_is_data_being_created_no_user(self):
        ...
        request = self.client_unauthenticated.post("/v1/data/file/", data=data)
        max_id = DataFile.objects.aggregate(Max("id"))["id__max"]
        self.assertEqual(request.status_code, status.HTTP_201_CREATED)
        self.assertEqual(
            request.data,
    ...
    def test_does_file_upload_update(self):
        ...
        request = self.client_authenticated.put("/v1/data/file/1/", data=data)
        self.assertEqual(
            request.data,
            {
                "current_user": "testUser",
    ...
    def test_unauthorized_file_upload_update(self):
        ...
        data = {"file": file, "is_public": False}
        request = self.client_unauthenticated.put("/v1/data/file/1/", data=data)
    ...
    def test_file_upload_update_not_found(self):
        file = open(find("cyl_400_40.txt"))
        data = {"file": file, "is_public": False}
        request = self.client_unauthenticated.put("/v1/data/file/5/", data=data)
        self.assertEqual(request.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_delete_unauthorized(self):
        request = self.client_unauthenticated.delete("/v1/data/file/1/")
        self.assertEqual(request.status_code, status.HTTP_401_UNAUTHORIZED)
...
class TestAccessManagement(TestCase):
    ...
    def test_grant_access(self):
        ...
        request1 = self.client_owner.put("/v1/data/file/1/users/", data=data)
        request2 = self.client_other.get("/v1/data/file/1/")
    ...
    def test_remove_access(self):
        ...
        request1 = self.client_other.get("/v1/data/file/2/")
        request2 = self.client_owner.put("/v1/data/file/2/users/", data=data)
        request3 = self.client_other.get("/v1/data/file/2/")
        self.assertEqual(request1.status_code, status.HTTP_200_OK)
        self.assertEqual(request2.status_code, status.HTTP_200_OK)
    ...
    def test_remove_no_access(self):
        data = {"username": "testUser2", "access": False}
        request1 = self.client_other.get("/v1/data/file/1/")
        request2 = self.client_owner.put("/v1/data/file/1/users/", data=data)
        request3 = self.client_other.get("/v1/data/file/1/")
    ...
    def test_cant_revoke_own_access(self):
        ...
        request1 = self.client_owner.put("/v1/data/file/1/users/", data=data)
        request2 = self.client_owner.get("/v1/data/file/1/")
        self.assertEqual(request1.status_code, status.HTTP_200_OK)
        self.assertEqual(request2.status_code, status.HTTP_200_OK)
        self.assertEqual(
            request1.data,
    ...
    def test_no_edit_access(self):
        data = {"is_public": True}
        request = self.client_other.put("/v1/data/file/2/", data=data)
    ...
    def test_only_view_access_to_owned_file(self):
        request1 = self.client_other.get("/v1/data/file/1/users/")
        request2 = self.client_other.get("/v1/data/file/2/users/")
        self.assertEqual(request1.status_code, status.HTTP_403_FORBIDDEN)
    ...
    def test_only_edit_access_to_owned_file(self):
        ...
        request1 = self.client_other.put("/v1/data/file/1/users/", data=data1)
        request2 = self.client_other.put("/v1/data/file/2/users/", data=data2)
        request3 = self.client_other.get("/v1/data/file/1/")
        request4 = self.client_owner.get("/v1/data/file/2/")
        self.assertEqual(request1.status_code, status.HTTP_403_FORBIDDEN)
        self.assertEqual(request2.status_code, status.HTTP_403_FORBIDDEN)
        self.assertEqual(request3.status_code, status.HTTP_403_FORBIDDEN)
